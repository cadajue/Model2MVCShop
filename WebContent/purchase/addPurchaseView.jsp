	...
	$("#discountCoupon").change(function() {
			...
			$.ajax({
				...
				success : function(JSONData, status) {
					var discountPrice = "할인 가격 : ";
					discountPrice = discountPrice.concat(JSONData.price);
	...
	<form name="addPurchase" method="post">
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td id="totalPrice" class="ct_write01">${product.price}</td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01"><select name="discountCoupon"
					id="discountCoupon" class="ct_input_g"
					style="width: 120px; height: 19px" maxLength="20">
