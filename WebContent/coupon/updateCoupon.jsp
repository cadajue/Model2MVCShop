...
function fncEditCoupon(){
	//Form 유효성 검증	

	document.detailForm.action='/coupon/updateCoupon';
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">정보수정</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			쿠폰명 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
				...
				<tr>
					<td width="105">
						<input 	type="text" name="couponName" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="${coupon.couponName}">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="price" value="${coupon.minimum_price}"
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="javascript:fncEditCoupon()">수정</a>
					</td>
